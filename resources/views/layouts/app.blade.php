            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        @auth
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('hoteles',['id' => auth()->user()->_id]) }}">Home</a>
                        </li>
                        @endauth
                        @auth
                        @if (auth()->user()->rol == 'G')
                        ...
                        @auth
                            @if (auth()->user()->rol == 'M')
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('hotel',['ruc_hotel' => Hotel::getRuc(auth()->user()->email), 'id_user' => auth()->user()->_id])}}">Hotel</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (matchedResults.length === 0) {
                ...
                matchedResults.forEach(result => { 
                    ...
                    link.href = "{{ route('hotel', ['ruc_hotel' => Hotel::getRuc(auth()->user()->email), 'id_user' => auth()->user()->_id]) }}" + "/?letrero=" + result; // Establece el enlace deseado aquí
